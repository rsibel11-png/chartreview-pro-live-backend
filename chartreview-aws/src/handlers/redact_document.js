...
// Updated: 2026-05-23 — tightened prompt to catch patient name/DOB/account# header blocks
...
async function detectPiiInPdf(pdfBytes) {
  ...
  const prompt = [
    ...
    '',
    '1. PATIENT NAME — any text on a line labeled "PATIENT:" or containing the patient full name.',
    '   Examples: "PATIENT: MORA-MALDONADO,VILMA N" — redact "MORA-MALDONADO,VILMA N"',
    '   Also redact patient names appearing in address blocks or demographic header sections.',
    '',
    '2. DATE OF BIRTH and AGE — any text on a line labeled "DOB:" or "DATE OF BIRTH:" or "D.O.B."',
    '   Also redact the numeric age if it appears next to the DOB (e.g. "AGE: 56").',
    '   Examples: "DOB: 05/21/69  AGE: 56" — redact both the date and the age value.',
    '',
    '3. PATIENT ACCOUNT NUMBER — text labeled "ACCOUNT#:", "ACCT#:", "ACCOUNT NO:", "ACCT NO:"',
    '   Examples: "ACCOUNT#: D00136377973" — redact "D00136377973"',
    '',
    '4. PATIENT UNIT / ROOM / BED — text labeled "UNIT #:", "ROOM/BED:", "ROOM:", "BED:"',
    '   These are patient location identifiers that can identify the individual.',
    '   Examples: "UNIT #: D003081753", "ROOM/BED: D.DTCS-2" — redact the values.',
    '',
    '5. SOCIAL SECURITY NUMBER — any SSN or partial SSN.',
    '',
    '6. PATIENT HOME ADDRESS — street address, city, zip belonging to the patient.',
    '',
    '7. PATIENT PERSONAL PHONE OR EMAIL — personal contact info for the patient.',
    '',
    '8. PATIENT MEDICAL RECORD NUMBER (MRN) — labeled "MRN:", "MR#:", "MED REC#:"',
    '   Note: do NOT confuse with encounter numbers or billing codes.',
    '',
    '9. PATIENT INSURANCE ID / MEMBER ID / POLICY NUMBER — insurance identifiers for the patient.',
    '',
    '10. PATIENT DRIVER LICENSE NUMBER.',
    '',
    '11. PATIENT PHOTO or PHOTO ID — photos of the patient face or ID card.',
    '',
    '12. PATIENT HANDWRITTEN SIGNATURE.',
    '',
    '=== DO NOT REDACT — KEEP VISIBLE ===',
    '',
    '- Treating physician or provider names and credentials',
    '  Examples: "ATTEND: Ching,Wilbert MD", "AUTHOR: Ching,Wilbert MD", "Roman A. Sibel, MD"',
    '',
    '- Hospital or facility names (e.g. "St. Rose Dominican Hospitals", "Sunrise Hospital")',
    '',
    '- Report/document titles, section headers, form labels',
    '  Examples: "Med Rec", "Subjective", "Objective", "Physician Activity"',
    '',
    '- Encounter numbers, case numbers, or billing procedure codes',
    '  Examples: "38204004", "CPT 27691", "ICD M79.3"',
    '',
    '- Dates of service, admission dates, discharge dates',
    '  Examples: "ADM DT: 10/02/25", "REP SRV DT: 10/03/25"',
    '',
    '- Clinical content: diagnoses, medications, vital signs, lab values',
    '',
    '- Hospital fax/phone numbers, hospital addresses',
    '',
    '- Page numbers, timestamps, or system-generated headers',
    '  Examples: "Page 1 of 4", "GMH001-03  4/8/2026  10:00:13 AM"',
    '',
    '- Fax transmission metadata: "CorVel Received Date:", fax server info',
    '',
    '=== INSTRUCTIONS ===',
    '',
    'For each page, return bounding boxes ONLY around the actual PII values — not the labels.',
    'For example, for "PATIENT: MORA-MALDONADO,VILMA N" — draw the box around "MORA-MALDONADO,VILMA N" only, not "PATIENT:".',
    'For "DOB: 05/21/69  AGE: 56" — draw one box covering both the DOB value and the age value.',
    '',
