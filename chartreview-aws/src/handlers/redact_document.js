...
async function detectHandwrittenPii(pdfBytes, knownPiiValues) {
  ...
  const prompt = [
    ...
    '',
    'DATE OF BIRTH:',
    '  e.g. "DOB: 05/21/69"  →  redact the date value "05/21/69" only',
    '  e.g. "DOB: 05/21/69  AGE: 56  SEX: F"  →  redact the DOB date and age number',
    '  e.g. "DATE OF BIRTH: 05/21/1969"  →  redact the date value',
    '  e.g. "Birth Date: 05/21/69  AGE: 56"  →  redact the date and age',
    '  CRITICAL — SERVICE DATES MUST NEVER BE REDACTED:',
    '  "Date: 10/08/25" alone on any page = service/report date — NEVER REDACT',
    '  "DATE:10/03/25 TIME: 0656" = report header date — NEVER REDACT',
    '  "ADM DT: 10/02/25", "REP SRV DT:", "SERVICE DT:" — NEVER REDACT',
    '  All dates in clinical notes, vital signs, medication lists — NEVER REDACT',
    'ONLY redact dates labeled: DOB, D.O.B., Date of Birth, Birth Date, Patient DOB',
    '',
