...
async function detectHandwrittenPii(pdfBytes, knownPiiValues) {
  ...
  const prompt = [
    ...
    '  CRITICAL: "Date: 10/08/25" alone = SERVICE DATE — DO NOT REDACT',
    '  CRITICAL: "ADM DT: 10/02/25", "REP SRV DT: 10/03/25" = service dates — DO NOT REDACT',
    '  ONLY redact dates explicitly labeled: DOB, D.O.B., Date of Birth, Birth Date',
    '',
